...
const ICONS = {
    ...
    hifz: (
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" d="M17.593 3.322c1.1.128 1.907 1.077 1.907 2.185V21L12 17.25 4.5 21V5.507c0-1.108.806-2.057 1.907-2.185a48.507 48.507 0 0111.186 0z" />
    ),
    tasbih: (
    ...
    routines: (
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" d="M8.25 6.75h12M8.25 12h12m-12 5.25h12M3.75 6.75h.007v.008H3.75V6.75zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zM3.75 12h.007v.008H3.75V12zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm-.375 5.25h.007v.008H3.75v-.008zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
    ),
    todos: (
    ...
    zakat: (
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" d="M12 3v17.25m0 0c-1.472 0-2.882.265-4.185.75M12 20.25c1.472 0 2.882.265 4.185.75M18.75 4.97A48.416 48.416 0 0012 4.5c-2.291 0-4.545.16-6.75.47m13.5 0c1.01.143 2.01.317 3 .52m-3-.52l2.62 10.726c.122.499-.106 1.028-.589 1.202a5.988 5.988 0 01-2.031.352 5.988 5.988 0 01-2.031-.352c-.483-.174-.711-.703-.59-1.202L18.75 4.971zm-16.5.52c.99-.203 1.99-.377 3-.52m0 0l2.62 10.726c.122.499-.106 1.028-.589 1.202a5.989 5.989 0 01-2.031.352 5.989 5.989 0 01-2.031-.352c-.483-.174-.711-.703-.59-1.202L5.25 4.971z" />
    ),
    goals: (
    ...
    reports: (
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.8" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25M9 16.5l1.5-1.5L13.5 18M6.75 21.75h10.5a2.25 2.25 0 002.25-2.25V17.25M6.75 21.75H4.5a2.25 2.25 0 01-2.25-2.25V6a2.25 2.25 0 012.25-2.25h2.25M6.75 21.75v-4.5m0 0H4.5m2.25 0h2.25" />
    ),
    circles: (
...
export default function SidebarLink({ routeName, label, icon, active = false, accent = false, collapsed = false }) {
    const iconPath = ICONS[icon] ?? ICONS.dashboard;
    const baseClass = accent
        ? 'mt-2 flex items-center gap-3 rounded-lg bg-accent px-3 py-2 text-sm font-semibold text-accent-content shadow hover:bg-accent/90'
